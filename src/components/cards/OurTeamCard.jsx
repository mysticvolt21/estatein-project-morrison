...
const OurTeamCard = ({
  ...
  return <div className="p-5 lg:p-6 xl:p-7.5 border border-Grey-15 rounded-xl flex flex-col gap-10 lg:gap-12.5" {...aos}>
     <div className="relative">
      ...
      <div className="flex flex-col gap-4 lg:gap-5 xl:gap-6 flex-1">
        ...
        <div className="relative mt-auto">
          ...
          <img src="/assets/icons/telegram.svg" alt="send icon" className="w-5 h-5 xl:w-6 xl:h-6" />
          </button>
        </div>
      </div>
    </div>;
