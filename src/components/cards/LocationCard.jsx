...
function LocationCard({
  ...
  return <div className="w-full h-[98%] bg-Grey-08 border border-Grey-15 p-6 lg:p-10 xl:p-12.5 rounded-xl flex flex-col xl:gap-10 md:gap-7.5 gap-6">
        ...
        return <InfoComponent key={index} icon={cont.icon} desc={cont.title} padding={"py-2.5 px-4 xl:py-3.5 xl:px-5"} />;
      })}
            </div>
