...
function ValuedClientsCard({
  ...
  return <div className=" w-full border border-Grey-15 p-6 md:p-10 xl:p-12.5 rounded-[10px] md:rounded-xl 
        flex flex-col gap-7.5 xl:gap-10 justify-between m-0 shadow-[0_0_0_6px_var(--color-Grey-10)] md:shadow-[0_0_0_8px_var(--color-Grey-10)]">
            ...
            <div className="flex gap-4 md:gap-5 xl:gap-7.5">
                {subCards.map((item, index) => <div key={index} className={`${index === 0 ? '' : 'border-l border-Grey-15 pl-4 md:pl-5 xl:p-7,5'} w-[45.5456%]`}>
