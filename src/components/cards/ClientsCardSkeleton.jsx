const ClientsCardSkeleton = () => {
  return <div className="w-full bg-Grey-08 border border-Grey-15 rounded-xl p-7.5 md:p-10 xl:p-12.5 flex flex-col justify-between gap-6 md:gap-7.5 xl:gap-10 animate-pulse">
      <div className="flex gap-2 xl:gap-2.5">
        {Array.from({
        length: 5
      }).map((_, i) => <div key={i} className="flex items-center justify-center rounded-full bg-Grey-15 border border-Grey-15 p-1.5 md:p-2 xl:p-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-[18px] md:w-[20px] xl:w-[24px] text-Grey-40" fill="currentColor" viewBox="0 0 24 24">
