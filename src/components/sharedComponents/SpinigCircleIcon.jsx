...
function SpinigCircleIcon({
  ...
  return <div className={`relative  ${isValuesCard ? "mt-0" : "mt-8"} xs:mt-0 w-12 h-12 lg:w-15 lg:h-15 2xl:w-20.5 2xl:h-20.5 z-10`}>
      <div className={`relative rounded-full ${isValuesCard ? "bg-Grey-08" : "bg-Grey-10"} w-12 h-12 lg:w-15 lg:h-15 2xl:w-20.5 2xl:h-20.5 flex justify-center items-center
        ...
        <div className={`relative rounded-full ${isValuesCard ? "bg-Grey-08" : "bg-Grey-10"} w-9 h-9 lg:w-11 lg:h-11 2xl:w-15.5 2xl:h-15.5 
          ...
          <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9 lg:w-11 lg:h-11 2xl:w-15.5 2xl:h-15.5 ${isValuesCard ? "bg-Grey-08" : "bg-Grey-10"} rounded-full z-30 flex justify-center items-center`}>
            <img src={iconURL} alt="icon" className="w-5 h-5 lg:w-6 lg:h-6 2xl:w-8.5 2xl:h-8.5" />
          </div>
        </div>
      </div>
    </div>;
