...
function Additional({
  ...
  return <div className={`flex flex-col gap-2.5 md:gap-3 xl:gap-4 ${className}`} {...aos}>
            ...
            <div className="flex gap-2 items-center lg:flex-wrap">
                ...
                {hasDesc && <p className="py-1 px-3 md:py-1.5 xl:py-2 xl:px-3.5 border border-Grey-15 rounded-md md:rounded-[28px] bg-Grey-10
