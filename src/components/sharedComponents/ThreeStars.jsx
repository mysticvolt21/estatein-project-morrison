...
function ThreeStars() {
  return <div className="flex items-center justify-between gap-1.5 w-fit overflow-hidden">
      <Star colorClass="fill-Grey-40" />
      <Star widthClass="w-3 md:w-[14.4px] 2xl:w-4.5 h-3 md:h-[14.4px] 2xl:h-4.5" colorClass="fill-Grey-20" />
      <Star widthClass="w-[5.6px] md:w-[6.72px] 2xl:w-[8.4px] h-[5.6px] md:h-[6.72px] 2xl:h-[8.4px]" colorClass="fill-Grey-20" />
    </div>;
}
...
function Star({
  ...
  return <svg className={`${widthClass} ${colorClass}`} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" fill="currentColor">
      <defs>
        <mask id="holeMask">
