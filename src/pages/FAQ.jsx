...
const FAQ = () => {
  ...
  return <div className="min-h-screen pt-[108px] lg:pt-[77px] xl:pt-[99px]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-Grey-08 via-Grey-10 to-Grey-08 py-20 md:py-30 xl:py-37.5">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-40 right-20 w-6 h-6 bg-Purple-75/20 rounded-full animate-pulse" style={{
          animationDelay: "1s"
        }}></div>
          <div className="absolute bottom-20 left-1/4 w-3 h-3 bg-Purple-60/40 rounded-full animate-pulse" style={{
          animationDelay: "2s"
        }}></div>
          <div className="absolute top-1/2 right-1/3 w-5 h-5 bg-Purple-75/25 rounded-full animate-pulse" style={{
          animationDelay: "0.5s"
        }}></div>
          ...
          <div className="text-center relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 xl:gap-10 max-w-4xl mx-auto">
              ...
              <div className="relative group" data-aos="fade-down">
                <div className="bg-Grey-10 border border-Purple-60/30 rounded-2xl p-6 md:p-8 transition-all duration-300 group-hover:border-Purple-60 group-hover:shadow-[0_0_20px_rgba(112,59,247,0.3)]">
                  <div className="text-3xl md:text-4xl xl:text-5xl font-bold text-Purple-75 mb-2 animate-pulse" style={{
                  animationDelay: "0.5s"
                }}>
                    24/7
                  </div>
      ...
      <section className="py-20 md:py-30 xl:py-37.5 bg-Grey-08 relative">
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7.5 xl:gap-10 z-30">
            {loading ? Array.from({
            length: 6
          }).map((_, i) => <FAQCardSkeleton key={i} />) : error ? <div className="col-span-full text-center text-Grey-60">Error loading FAQs: {error}</div> : items.length > 0 ? items.map((faq, index) => <FAQCard key={faq.id} faq={faq} showButton={true} withShadow={false} data-aos="fade-up" data-aos-delay={index * 100} />) : <div className="col-span-full text-center text-Grey-60">No FAQs available</div>}
          </div>
