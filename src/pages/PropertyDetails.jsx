...
const PropertyDetails = () => {
  ...
  const property = useSelector(state => state.properties.items[0]);
  ...
  const propertyDetailsData = {
    ...
    description: {
      ...
      details: [{
        ...
        icon: <Area />,
        label: "Area",
        value: property.area ? `${property.area.toLocaleString()} Square Feet` : ""
      }],
      features: (property.features || []).map(label => ({
        icon: <Lightning />,
        label
      }))
    }
  ...
  const pricingDetailsData = {
    ...
    pricingDetailsCards: [{
      ...
      pricingCard: [{
        ...
        value: property.transfer_tax != null ? "$".concat(property.transfer_tax.toLocaleString()) : "-",
        description: "Based on sale price and local regulations"
      }, {
        label: "Legal Fees",
        value: property.legal_fees != null ? "$".concat(property.legal_fees.toLocaleString()) : "-",
        description: "Approximate legal services"
      }, {
        label: "Home Inspection",
        value: property.inspection != null ? "$".concat(property.inspection.toLocaleString()) : "-",
        description: "Recommended for due diligence"
      }, {
        label: "Property Insurance",
        value: property.insurance != null ? "$".concat(property.insurance.toLocaleString()) : "-",
        description: "Annual insurance cost"
      }, {
        label: "Mortgage Fees",
        value: property.mortgage_fees != null ? property.mortgage_fees : property.expense_mortgage || "-",
      ...
      pricingCard: [{
        ...
        value: property.monthly_taxes != null ? "$".concat(property.monthly_taxes.toLocaleString()) : "-",
        description: "Approximate monthly property tax based on the sale price and local rates"
      }, {
        label: "Homeowners' Association Fee",
        value: property.hoa_fee != null ? "$".concat(property.hoa_fee.toLocaleString()) : "-",
      ...
      pricingCard: [{
        label: "Listing Price",
        value: "$".concat((property.listing_price ?? property.price).toLocaleString())
      }, {
        label: "Additional Fees",
        value: property.total_additional_fees != null ? "$".concat(property.total_additional_fees.toLocaleString()) : "-",
        description: "Property transfer tax, legal fees, inspection, insurance"
      }, {
        label: "Down Payment",
        value: property.down_payment != null ? "$".concat(property.down_payment.toLocaleString()) : "-",
        description: "20%"
      }, {
        label: "Mortgage Amount",
        value: property.mortgage_amount != null ? "$".concat(property.mortgage_amount.toLocaleString()) : "-",
      ...
      pricingCard: [{
        ...
        value: property.expense_mortgage || "Varies based on terms and interest rate",
        description: "If applicable"
      }, {
        label: "Property Insurance",
        value: property.expense_insurance != null ? "$".concat(property.expense_insurance.toLocaleString()) : "-",
