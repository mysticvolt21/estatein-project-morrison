        ...
        <div>
          <div className="bg-Grey-10 rounded-2xl p-8 md:p-12 shadow-2xl border border-Grey-15">
            <div className="space-y-12">
              {privacyData.map((section, index) => <section key={section.id} className="group" data-aos="fade-up" data-aos-delay={index * 20}>
              ...
              <div className="text-center pt-8 border-t border-Grey-15">
                <Link data-aos="zoom-in" to="/" className="inline-flex items-center text-white px-8 py-4 bg-gradient-to-r from-Purple-60 to-Purple-65 rounded-xl hover:from-Purple-65 hover:to-Purple-70 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1">
