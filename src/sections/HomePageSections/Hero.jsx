...
const Hero = () => {
  const description = "Your journey to finding the perfect property begins here. Explore our listings to find the home that matches your dreams.";
  const headline = "Discover Your Dream Property with Estatein";
  const heroImage = "/assets/images/Home/heroBuilding.webp";
  return <section id={'hero'} className="px-[4.1025%] md:px-[5.5555%] xl:px-[8.4375%] min-h-screen max-lg:gap-14 pt-[108px] lg:pt-[77px] xl:pt-[99px] flex justify-between items-center max-lg:flex-col-reverse lg:pr-0 xl:pr-0">
      {/* Left Content */}
      ...
      <div className="relative lg:w-[52.3321%] w-full max-lg:h-[44.3618vh] max-lg:border border-Grey-15 max-lg:rounded-xl self-stretch bg-Grey-10">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Gradient Overlay */}
          <div className="absolute inset-0 z-20 pointer-events-none max-lg:rounded-tr-xl dark:bg-[linear-gradient(238.21deg,#2A213F_8.76%,rgba(25,25,25,0)_50.09%)]
                                                                                           bg-[linear-gradient(238.21deg,#703bf790_8.76%,rgba(25,25,25,0)_50.09%)]"></div>

          {/* Foreground Image - contain */}
          <img data-aos="fade-up" src={heroImage} alt="hero" className="absolute left-1/2 bottom-0 translate-x-[-50%] object-bottom inset-0 w-full h-full object-contain z-30" />
        </div>
