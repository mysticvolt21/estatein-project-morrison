export default function DescriptionSection({
  ...
  return <div className=" lg:w-[49.0601%] w-full h-fit rounded-xl border border-Grey-15 p-5 
      ...
      <div className="flex flex-wrap lg:flex-nowrap lg:justify-between gap-y-5">
        ...
        return <div key={index} data-aos="fade-up" data-aos-delay={index * 200} className={`
                w-1/2 lg:w-auto flex flex-col gap-1.5 md:gap-2 xl:gap-2.5 
                ${index !== 0 && !isLast ? "border-l border-Grey-15 pl-4" : ""}
                ${isLast ? "w-full border-t border-Grey-15 pt-5 lg:pt-0 lg:w-auto lg:border-t-0 lg:border-l lg:pl-4" : ""}
              `}>
