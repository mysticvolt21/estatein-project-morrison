...
export const contactLetsConnectData = {
  title: "Let's Connect",
...
export const contactLetsConnectFormData = {
  conactForm: [{
    id: "firstName",
    name: "firstName",
    label: "First Name",
...
export const contactDiscoverLocationsData = {
...
export const contactDiscoverLocationsFilterData = {
...
export const contactExplorePhotosData = {
  photos: [{
    id: "exploreOffice",
  ...
  contactExploreEstateinData: {
    ...
    description: "Discover the world of Estatein and its impact on the real estate industry. From our team of experts to our commitment to excellence, we're here to guide you on your real estate journey."
  },
