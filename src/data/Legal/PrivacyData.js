export const privacyData = [{
  ...
  subsections: [{
    ...
    content: ["Name, email address, and phone number", "Mailing address and property preferences", "Financial information for mortgage pre-approval", "Property search criteria and preferences", "Communication preferences and history", "Account credentials and profile information"]
  }, {
    title: "2.2 Automatically Collected Information",
    content: ["IP address and device information", "Browser type and version", "Pages visited and time spent on each page", "Referring website and search terms", "Cookies and similar tracking technologies"]
  }]
}, {
  id: "information-usage",
  title: "3. How We Use Your Information",
  content: ["Providing and improving our real estate services", "Processing property inquiries and requests", "Sending relevant property listings and market updates", "Facilitating communication between buyers, sellers, and agents", "Personalizing your experience and content", "Analyzing website usage and improving functionality", "Complying with legal obligations and regulations", "Preventing fraud and ensuring security"]
}, {
  ...
  subsections: [{
    ...
    content: ["Service Providers: With trusted third-party service providers who assist us in operating our website and services", "Legal Requirements: When required by law or to protect our rights and safety", "Business Transfers: In connection with a merger, acquisition, or sale of assets", "Consent: With your explicit consent for specific purposes", "Real Estate Partners: With other real estate professionals when necessary for transactions"]
  }]
}, {
  id: "cookies-tracking",
  ...
  subsections: [{
    ...
    content: ["Remember your preferences and settings", "Provide personalized content and recommendations", "Analyze website traffic and user behavior", "Improve website performance and functionality"]
  }]
}, {
  id: "data-security",
  ...
  subsections: [{
    ...
    content: ["Encryption of sensitive data in transit and at rest", "Regular security assessments and updates", "Access controls and authentication procedures", "Employee training on data protection practices", "Incident response and breach notification procedures"]
  }]
}, {
  id: "data-retention",
  ...
  subsections: [{
    ...
    content: ["The nature and purpose of the information collected", "Legal and regulatory requirements", "Ongoing business relationships and transactions", "Your consent and preferences"]
  }]
}, {
  id: "privacy-rights",
  ...
  subsections: [{
    title: "User Rights",
    content: ["Access: Request access to your personal information", "Correction: Request correction of inaccurate or incomplete information", "Deletion: Request deletion of your personal information", "Portability: Request a copy of your data in a portable format", "Opt-out: Opt out of marketing communications and data sharing", "Restriction: Request restriction of processing in certain circumstances"]
  }]
}, {
  id: "children-privacy",
