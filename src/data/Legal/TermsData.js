export const termsData = [{
  ...
  content: ["Welcome to X2-ADV Real Estate (\"we,\" \"our,\" or \"us\"). These Terms of Use govern your use of our website, mobile applications, and services (collectively, the \"Service\") operated by X2-ADV Real Estate.", "By accessing or using our Service, you agree to be bound by these Terms. If you disagree with any part of these terms, then you may not access the Service."]
}, {
  id: "services",
  ...
  subsections: [{
    title: "Services List",
    content: ["Property listings and search functionality", "Real estate consultation and advisory services", "Property valuation and market analysis", "Buyer and seller representation", "Investment property guidance", "Property management services"]
  }]
}, {
  id: "accounts",
  ...
  content: ["The Service and its original content, features, and functionality are and will remain the exclusive property of X2-ADV Real Estate and its licensors. The Service is protected by copyright, trademark, and other laws.", "Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent."]
}, {
  id: "user-content",
  title: "5. User-Generated Content",
  content: ["By posting content to the Service, you grant us the right and license to use, modify, publicly perform, publicly display, reproduce, and distribute such content on and through the Service.", "You retain any and all of your rights to any content you submit, post, or display on or through the Service and you are responsible for protecting those rights."]
}, {
  id: "privacy",
  ...
  subsections: [{
    ...
    content: ["In any way that violates any applicable federal, state, local, or international law or regulation", "To transmit, or procure the sending of, any advertising or promotional material", "To impersonate or attempt to impersonate the company, a company employee, another user, or any other person", "To engage in any other conduct that restricts or inhibits anyone's use or enjoyment of the Service", "To introduce viruses, trojan horses, worms, logic bombs, or other material that is malicious or technologically harmful"]
  }]
}, {
  id: "disclaimers",
  title: "8. Disclaimers",
  content: ["The information on this Service is provided on an \"as is\" basis. To the fullest extent permitted by law, this Company excludes all representations, warranties, conditions and terms whether express or implied.", "Property information, including but not limited to prices, availability, and property details, is subject to change without notice and may not be accurate at the time of viewing."]
}, {
